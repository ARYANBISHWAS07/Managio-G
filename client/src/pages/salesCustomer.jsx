      ...
      <div className="bg-card border rounded-lg shadow-sm p-5 mb-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-lg font-semibold tracking-tight">Customer management</h1>
              <p className="mt-0.5 text-xs text-muted-foreground">Manage and track your customer information</p>
            </div>
          </div>
          {/* <Button
